...
const en: Copy = {
  ...
  hero: {
    ...
    badges: ["Local from Kashyapagama", "Small groups only", "Pick-up included", "Pay after the tour"],
  },
  video: {
    kicker: "Video",
  ...
  about: {
    ...
    paragraphs: [
      "My full name is Menantheus Roshen Muduwantha and I live in Kashyapagama, the village directly behind Pidurangala Rock. I grew up climbing these boulders, walking the jungle paths and swimming in the old tanks around Sigiriya.",
    ...
    facts: [
      { label: "Based in", value: "Kashyapagama, Pidurangala" },
...
const de: Copy = {
  ...
  hero: {
    ...
    badges: ["Einheimischer aus Kashyapagama", "Nur kleine Gruppen", "Abholung inklusive", "Zahlung nach der Tour"],
  },
  video: {
    kicker: "Video",
  ...
  about: {
    ...
    paragraphs: [
      "Mein voller Name ist Menantheus Roshen Muduwantha, und ich lebe in Kashyapagama, dem Dorf direkt hinter dem Pidurangala-Felsen. Ich bin hier aufgewachsen: auf diesen Felsen geklettert, über die Dschungelpfade gelaufen, in den alten Stauseen rund um Sigiriya geschwommen.",
    ...
    facts: [
      { label: "Zuhause in", value: "Kashyapagama, Pidurangala" },
...
const si: Copy = {
  ...
  hero: {
    ...
    badges: ["කාශ්‍යපගම ගමේ", "කුඩා කණ්ඩායම් පමණයි", "රැගෙන යාම ඇතුළත්", "චාරිකාවෙන් පසු ගෙවීම"],
  },
  video: {
    kicker: "වීඩියෝ",
  ...
  about: {
    ...
    paragraphs: [
      "මගේ සම්පූර්ණ නම මෙනන්තියුස් රොෂෙන් මුදුවන්ත. මම ජීවත් වන්නේ පිදුරංගල පර්වතයට හරියටම පිටුපසින් ඇති කාශ්‍යපගම ගමේ. මම හැදී වැඩුණේ මේ ගල් නගිමින්, වන පාරවල් දිගේ ඇවිදිමින්, සීගිරිය අවට පැරණි වැව්වල පිහිනමින්.",
    ...
    facts: [
      { label: "පදිංචිය", value: "කාශ්‍යපගම, පිදුරංගල" },
...
const hi: Copy = {
  ...
  hero: {
    ...
    badges: ["कश्यपगमा का स्थानीय निवासी", "सिर्फ़ छोटे समूह", "पिक-अप शामिल", "यात्रा के बाद भुगतान"],
  },
  video: {
    kicker: "वीडियो",
    title: "यहाँ का एक पल",
  ...
  about: {
    ...
    paragraphs: [
      "मेरा पूरा नाम मेनन्थियस रोशन मुदुवंथा है और मैं कश्यपगमा में रहता हूँ, वह गाँव जो ठीक पिदुरंगला चट्टान के पीछे है। मैं इन्हीं चट्टानों पर चढ़ते, जंगल की पगडंडियों पर चलते और सिगिरिया के पुराने तालाबों में तैरते हुए बड़ा हुआ हूँ।",
    ...
    facts: [
      { label: "निवास", value: "कश्यपगमा, पिदुरंगला" },
  ...
  contact: {
    ...
    call: "सीधे कॉल करें",
    guideLabel: "गाइड",
    addressLabel: "मैं यहाँ रहता हूँ",
